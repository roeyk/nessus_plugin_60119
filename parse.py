...
#        print(f'starting FILE_GENERIC_EXECUTE: "{cur_perm_exec}"')
        ...
        ent = Line(cur_path, cur_share_path, cur_users, cur_users_hash, cur_perm_read, cur_perm_write, cur_perm_exec, cur_comment)
        database.append(ent)
#        print(f'added new entity: {ent}')
          
        # zero-out the old info, retaining the current path
        cur_users = cur_perm_read = cur_perm_write = cur_perm_exec = cur_comment = ""
